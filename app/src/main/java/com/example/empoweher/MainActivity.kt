...
class MainActivity : ComponentActivity() {
    ...
    fun LocationScreen(currentLocation:LocationDetails){
        ...
        Column(modifier = Modifier.fillMaxSize()) {
            Text(text = "Your Location : Latitude is ${currentLocation.latitude}\nLongitude is ${currentLocation.longitude}",modifier=Modifier.fillMaxWidth(), textAlign = TextAlign.Center)
            Button(onClick = {
                             if (permissions.all {
